    ...
    <div className='flex w-auto justify-center flex-wrap my-14 gap-2'>
      {
       Data.map((item)=>{
        if(i<4){
          i++;
         return <Card key={item.id} name={item.name} brand={item.brand} category={item.category} src={item.image}/>
        }
      }
